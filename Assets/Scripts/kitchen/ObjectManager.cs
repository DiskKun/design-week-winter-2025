...
public class ObjectManager : MonoBehaviour
{
    ...
    public ZoneBehaviour zb;
    public BedroomZoneBehaviour bzb;
    public GameObject bedroomCover;
    ...
    void UpdateTiles()
    {
        ...
        if (zb.seenState == 13)
        {
            tilemap.SetTile(new Vector3Int(-7, -8, 0), floorTiles[0]);
            tilemap.SetTile(new Vector3Int(-7, -9, 0), floorTiles[1]);
            bzb.gameObject.SetActive(true);
            bedroomCover.SetActive(false);
